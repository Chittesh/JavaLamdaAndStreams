...
public class Functional10_CustomClass {
	...
	public static void main(String[] args) {
		...
		//Limit the results (The first limit values are captured)
		System.out.println(
				courses.stream().sorted(comparingByNoOfStudentsAndNoOfReviews).limit(5).collect(Collectors.toList()));
		// [Microservices:25000:96, API:22000:97, Azure:21000:99, AWS:21000:92,
		// Spring:20000:98]

		//Skippped (The values are skipped and rest are captured)
		System.out.println(
	...
	/*	System.out.println(courses);
		...
		System.out.println(courses.stream().filter(reviewScoreGreaterThan95Predicate).findFirst());// Optional[Spring:20000:98]

		System.out.println(courses.stream().filter(reviewScoreGreaterThan95Predicate).findAny());// Optional[Spring:20000:98]
